...
@inject AppLoginAspCore.Libraries.Login.LoginColaborador _colaborador
...
<head>
    ...
    <link rel="stylesheet" href="~/resources/lib/pagedlist/PagedList.css" rel="stylesheet" type="text/css" />
...
<body>
    <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
                    <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#">Painel</a>
                    <input class="form-control form-control-dark w-100" type="hidden" placeholder="" aria-label="Search">
        
        <ul class="navbar-nav px-3">
          <li class="nav-item text-nowrap">
               <a class="nav-link" asp-area="Colaborador" asp-action="Logout" asp-controller="Home"><span>@_colaborador.GetColaborador().Nome </span> Sair</a>
            </li>
    ...
    <script src="~/resources/lib/mask/jquery.mask.min.js"></script>
